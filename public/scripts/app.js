...
$(function ($) {
  ...
  const displayProperties = function (arr) {
    ...
    return arr.properties.forEach((property) => {
      ...
      <div class="card-body"><li class="list-group-item">  <h5 class="card-title">${property.address}</h5>Number of bedrooms: ${property.bedrooms}</h5> <ul class="list-group list-group-flush"><li class="list-group-item">Number of bathrooms: ${property.bathrooms}</li></ul></div>
